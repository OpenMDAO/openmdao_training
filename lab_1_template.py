...
class BatteryWeight(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials('W_battery',['*'])
...
class WeightBuild(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, partials):
        ...
        partials['TOW','W_battery'] = -75# TODO fill in with the correct value
        partials['TOW','W_payload'] = -75 # TODO fill in with the correct value
        partials['TOW','W_empty'] = -75# TODO fill in with the correct value
...
class ElecRangeGroup(om.Group):
    ...
    def setup(self):
        ...
        # TODO note that the ExecComp lets you define an ad-hoc component without having to make a class
...
if __name__ == "__main__":
    ...
    # TODO eventually try running the ElecRangeGroup instead
    ...
    if solver_flag == 'newton':
        ...
        # AssembledJacobian requires memory but greatly increases speed
        # Should almost always be turned on
    ...
    ### TODO If you want to list all inputs and outputs, uncomment the following
